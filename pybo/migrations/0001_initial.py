    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('voter', models.ManyToManyField(related_name='votor_question', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Answer',
            fields=[
                ...
                ('voter', models.ManyToManyField(related_name='votor_answer', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
